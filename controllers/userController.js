...
export const resetPassword = catchAsyncError(async (req, res, next) => {
  ...
  const resetPasswordToken=
   ...
   if(!user) return next (new ErrorHandler("Tokein invalid or expired"));
...
const message = `Click on link to reset your password. ${url},If you have not requested the ignore message`
